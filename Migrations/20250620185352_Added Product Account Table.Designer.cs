...
namespace DomainDrivenDesign.Migrations
{
    ...
    [Migration("20250620185352_Added Product Account Table")]
    partial class AddedProductAccountTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainDrivenDesign.Domain.Models.ProductAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainDrivenDesign.Domain.Models.ProductAudit", b =>
                {
                    b.HasOne("DomainDrivenDesign.Domain.Models.Product", null)
                        .WithMany("AuditTrail")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DomainDrivenDesign.Domain.Models.Sale", b =>
                {
                    b.HasOne("DomainDrivenDesign.Domain.Models.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("DomainDrivenDesign.Domain.Models.SaleItem", b =>
                {
                    b.HasOne("DomainDrivenDesign.Domain.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
